...
% TODO: maybe remove parallelization from the third bullet point
% TODO: maybe add swifter to packages if we end up using it before the deadline
...
\begin{itemize}\tightlist
  ...
  \item All operations are \textbf{optimized} both in terms of memory usage and computational runtime, in such a way that almost any file can be quickly processed even on less performing systems such as laptops. This is mostly achieved by chunking and vectorizing operations.
\end{itemize}
