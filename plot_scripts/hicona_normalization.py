...
def create_plot(filt_distr, norm_distr, count_distr, out_path):
    ...
    axes[0].set_ylabel("Filtered Counts", fontsize=10)
    axes[0].set(xscale="log")
    axes[0].tick_params(axis="both", labelsize=8)
    axes[0].legend(loc="upper center", title="Quantiles", fontsize=8, title_fontsize=10)
    ...
    axes[1].set_ylabel("Normalized Counts", fontsize=10)
    ...
    axes[2].set_ylabel("Num Pixels", fontsize=10)
...
if __name__ == "__main__":
    ...
    OUT_FOLDER = "plots/normalized_counts"
